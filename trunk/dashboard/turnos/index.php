...
<div id="ingoGral" style=" margin-left:240px; padding-top:20px;">
        ...
        <form class="form-horizontal formulario" role="form">
                ...
                <!--refcancha,fechautilizacion,horautilizacion,refcliente,fechacreacion,usuacrea -->
                    ...
                    <div id="error" class="alert alert-info">
                		<p><strong>Importante!:</strong> El campo fecha de utilizaci髇 y cliente son obligatorios</p>
                	</div>
    ...
    <div class="boxInfo">
        <div id="headBoxInfo">
        	<p style="color: #fff; font-size:18px; height:16px;">Turnos del d铆a de la fecha: <span id="fechaCambio"><?php echo date('Y-m-d'); ?></span></p>
        </div>
...
<div id="dialog2" title="Eliminar Turno">
    	<p>
            ...
            驴Esta seguro que desea eliminar al Turno?.<span id="proveedorEli"></span>
        </p>
...
$(document).ready(function(){
	...
	function validador(){
			...
			if ($("#fechautilizacion").val() == "") {
				$error = "Es obligatorio el campo fecha utilizaci贸n.";
