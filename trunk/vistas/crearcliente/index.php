...
<title>Administrador de Clientes</title>
        ...
        <script>
        	$(document).ready(function(){
        			...
        			$("#pais").removeClass("alert-danger");
        			$("#pais").attr('placeholder','Ingrese el país');
        			});
        			...
        			$("#telefonofijo").removeClass("alert-danger");
        			$("#telefonofijo").attr('placeholder','Ingrese el teléfono fijo');
        			});
        			...
        			$("#telefonomovil").removeClass("alert-danger");
        			$("#telefonomovil").attr('placeholder','Ingrese el teléfono movil');
        			});
        		...
        		function validador(){
						...
						if ($("#pais").val() == "") {
        					$error = "Es obligatorio el campo país.";
						...
						if ($("#telefonofijo").val() == "") {
        					$error = "Es obligatorio el campo teléfono fijo.";
						...
						if ($("#telefonomovil").val() == "") {
        					$error = "Es obligatorio el campo teléfono movil.";
...
padding-left:100px;">
  ...
  <li><a href="../datosfacturacion/">Datos de Facturación</a></li>
</ul>
</div>
			...
			<div id="load"></div>
				...
				<form role="form" method="POST" action="">
                    ...
                    <div class="form-group">
						...
						<input id="direccion" name="direccion" class="form-control" type="txt" placeholder="Ingrese la dirección">
					</div>
                    ...
                    <div class="form-group">
						...
						<input id="pais" name="pais" class="form-control" type="txt" placeholder="Ingrese el País">
					</div>
                    ...
                    <div class="form-group">
						<label for="telefonofijo"><span class="glyphicon glyphicon-earphone"> </span> Teléfono Fijo</label>
						<input id="telefonofijo" name="telefonofijo" class="form-control" type="txt" placeholder="Ingrese el Teléfono Fijo">
					</div>
                    
                    
                    <div class="form-group">
						<label for="telefonomovil"><span class="glyphicon glyphicon-phone"></span> Teléfono Movil </label>
						<input id="telefonomovil" name="telefonomovil" class="form-control" type="txt" placeholder="Ingrese el Teléfono Movil">
					</div>
