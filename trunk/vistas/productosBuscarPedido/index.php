...
<?
	...
	if (!isset($_GET['pedido']))  {
		...
		?>
			<h3>Debe ingresar un Nro de Pedido para buscar!!.</h3>
		...
		<?
			...
			$res = $serviciosProductos->BuscarProductosPorPedido($idCategoria,$pedido);
		...
		<div class="panel-heading">
			...
			<div class="panel-body">
                ...
                <? } else { ?>
                    ...
                    <p>Recuerde que el Nº de Pedido debe coincidir completamente</p>
                <? } ?>
               </div>
           </div>
           </div>
